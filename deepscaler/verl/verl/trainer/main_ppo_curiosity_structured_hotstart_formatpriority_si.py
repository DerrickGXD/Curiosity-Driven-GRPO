...
@hydra.main(config_path='config', config_name='ppo_trainer_curiosity_structured_formatpriority_si', version_base=None)
def main(config):
...
def main_task(config):
    ...
    filename_parameters = f"qwen7b_bs_{config.data.train_batch_size}_rollout_{config.actor_rollout_ref.rollout.n}_reasoningpattern_{config.reward_model.curiosity.reasoning_pattern_reward_coef}_reasoningpatterndescription_{config.reward_model.curiosity.reasoning_pattern_description_penalty_type}_{config.reward_model.curiosity.reasoning_pattern_description_reward_coef}_calculation_{config.reward_model.curiosity.calculation_penalty_type}_{config.reward_model.curiosity.calculation_reward_coef}_answer_{config.reward_model.curiosity.answer_reward_coef}_formatpriority_si_{config.reward_model.curiosity.si_coef}"

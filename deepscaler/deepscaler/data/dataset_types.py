...
class TrainDataset(enum.Enum):
    ...
    SMALL_DATA = 'SMALL_DATA'  # small dataset for debugging purpose
    TWO_DATA = 'TWO_DATA'  # small dataset for debugging purpose
    AIME_6 = 'AIME_6'  # small dataset for debugging purpose

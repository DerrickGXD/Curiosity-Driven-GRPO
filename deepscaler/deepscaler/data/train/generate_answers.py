...
def request_api(prompt,model_name,temperature=0.0,max_tokens=None,top_p=0.7,top_k=50,frequency_penalty=0,n=1):
...
def main():
    ...
    all_problems = all_problems[140:150]

    eval_output_path = "7b_qwen_generated_answers_aime_full.json"

...
python3 -m verl.trainer.main_ppo_curiosity_structured_hotstart_formatpriority_si \
    ...
    trainer.experiment_name='Qwen2.5-7B_curiosity_structured_hotstart_formatpriority_newcoeff_rerun_si_2' \

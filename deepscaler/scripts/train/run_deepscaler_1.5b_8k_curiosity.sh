...
CUDA_VISIBLE_DEVICES=1,2,3 python3 -m verl.trainer.main_ppo_curiosity \
    algorithm.adv_estimator=grpo \
    data.train_files=$HOME/deepscaler/data/train_aime.parquet \
    data.val_files=$HOME/deepscaler/data/train_aime.parquet \
